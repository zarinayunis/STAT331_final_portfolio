...
There are 30463 rows in the surveys data set. Each row is an observational unit, which represents an animal. There are 15 columns, or variables.
...
ggplot(data = surveys,
       mapping = aes(y = species,
         ...
         geom_jitter(width = 0.7, height = 0.4) +
         labs(x = "weight (grams)", y = "animal specie type")
...
ggplot(data = surveys,
       mapping = aes(x = species,
         ...
         geom_boxplot(col = 'red') + 
         geom_jitter(width = 0.7, height = 0.4) +
         labs(x = "weight (grams)", y = "specie type")
